...
| `image_prompt` | string | — | Prompt for the image. Defaults to `topic`. Max 4000 characters. |
| `size` | string | 1024x1024 | Width×height for the image, e.g. `1024x1024`, `1024x1536`. |
...
| 422 | `invalid_request_error` | Bad `topic`, `platform` or `hashtag_count` (0–30). |
