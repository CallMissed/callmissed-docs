...
| `deepgram-flux-tts` | $0.30 / 10K chars |
...
| `deepgram-flux-tts` | English | 12 (priya default) | $0.30 / 10K chars |
...
| `saaras:v4` | Sarvam STT with five output modes: transcribe, translate, verbatim, transliterate, code-mix. 24 languages. | — | Yes | $0.53 / hr |
