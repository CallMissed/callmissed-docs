...
| `gpt-realtime-mini` | Realtime voice | Cheapest Azure realtime, ~3× cheaper than gpt-realtime, live |
...
| `gpt-realtime-mini` | Cheaper Azure realtime — same single-model shape as gpt-realtime, ~3× cheaper. 20 concurrent. | 32K | No | $0.60 in / $2.40 out per 1M • $0.118/min |
| `gpt-realtime-2` | Newest Azure realtime with stronger tool calling. 128K text context. | 128K | No | $4.00 in / $24.00 out per 1M • $0.375/min |
