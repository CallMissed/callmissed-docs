...
/docs/models | Models | boxes | 122 models — Indic STT/TTS, direct-routed LLMs, realtime voice, image gen, embeddings
...
- Call **122 models** — LLM, STT, TTS, realtime voice, image and embeddings — from one endpoint, plus **300+ more we deploy on demand**
