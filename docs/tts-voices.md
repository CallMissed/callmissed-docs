...
**deepgram-flux-tts** provides **12 English voices** for streaming voice agents — synthesis is turn-based and prosody carries across turns. The default voice is `priya`, an Indian-accented English voice; an unrecognized voice falls back to the default.
