---
title: "CallMissed API Documentation"
description: "Complete API reference and guides for CallMissed — AI-powered communication APIs for WhatsApp chatbots and voice call agents."
---

# CallMissed API Documentation

AI-powered communication APIs to deploy WhatsApp chatbots and voice call agents.
...
- [Integration Settings API](settings-api.md)
...
- [Email API](email.md)
- [Domains & Senders](email-domains.md)
- [Send Email](email-send.md)
...
- [Welcome to CallMissed API](introduction.md)
...
- [Credits & Rate Limits](credits-rate-limits.md)
- [API Speed: Best Practices](api-speed.md)

## Knowledge

- [Knowledge Base & RAG](knowledge.md)
...
- [Model Access by Plan](models-access.md)
...
- [Business Setup](whatsapp-setup.md)
- [WhatsApp API](whatsapp-api.md)
